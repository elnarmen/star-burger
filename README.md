...
Получите ключ Yandex geocoder API в [кабинете разработчика](https://developer.tech.yandex.ru/services/)
и сохраните в файле `.env` в переменной `YANDEX_GEOCODER_API_KEY`
...
-`YANDEX_GEOCODER_API_KEY` - ключ необходим для получения координат на карте по адресу.
Получите ключ Yandex geocoder API в [кабинете разработчика](https://developer.tech.yandex.ru/services/)
## Цели проекта
